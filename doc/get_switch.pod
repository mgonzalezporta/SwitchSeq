...
gene_id (1)
transcript_id (2)
transcript FPKMs in each sample (3-).
Eg, for an experiment with 3 controls and 3 KO, column names could be the following:
...
=item B<--output> | B<-o> <dir>

html output dir. [default: ./html]
